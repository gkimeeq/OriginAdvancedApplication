Origin C访问Excel的流程跟访问Word差不多，可以参考[Origin C访问Word](https://www.cnblogs.com/Ooman/p/11089267.html)。

这里简单的演示怎样把Excel中的数据导入到Origin的工作表，用到的Excel文件位于Origin的安装目录下`Samples\COM Server and Client\MS Office\Excel\FFTFiltering.xls`，数据区域为`A20:B259`。
